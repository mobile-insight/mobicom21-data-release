...
set output  "dl_ca_quartertput_wl-v2.eps"
...
# set ylabel "Bandwidth (MHz)" offset 1.7, 0
set ylabel "BW (MHz)" offset 1.7, 0
set yrange [0:30]
set ytics 0,15,30
...
# set samples 11
# set style fill pattern 0.5 border
set style fill solid 0.5 border
set boxwidth 0.75 relative


plot "./ca_tput_quarter_wl.txt" using ($2):xticlabel(1) lw 4 lt -1 fc rgb "#000000"  
